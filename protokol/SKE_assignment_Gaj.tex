...
\end{table}
	...
	Funkce \texttt{Fit\_Everything} proloží poskytnutá data pomocí 15 předdefinovaných hustot a pro každou odhadne hodnoty parametrů. Následně vykreslí PP ploty a probabilitz ploty pro každý fit.
	...
	V Podsekcích~\ref{sec:non_parametric_drugs}~a~\ref{sec:non_parametric_placebo} jsou obě skupiny pacientů (léčení lékem a léčení placebem) 
	\begin{figure}[H]
		\centering
