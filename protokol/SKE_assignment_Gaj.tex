...
\begin{document}
	...
	Poskytnutý dataset představuje záznam testování vlivu jistého léčiva na  
...
\begin{tabular}{lrrrrrrrr}
	...
	\bottomrule
\end{tabular}
\caption{Základní analýza na celém datasetu}
\end{table}
...
\begin{figure}[H]
	...
	\caption[boxplotdrugvsplacebo]{boxplotdrugvsplacebo}
