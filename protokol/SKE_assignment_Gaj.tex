...
\end{table}
   ...
   \end{table}
    ...
    Obrázek~\ref{fig:SF_for_parametric} je ve shodě s Obrázkem~\ref{fig:TTTplot}, tedy ilustruje o něco rychlejší (ve smysu doby do úmrtí) průběh nemoci u pacientů, kteří dostávali placebo.
    ...
    \end{figure} 
   	...
   	\begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{img/cumulative_hazard_function_drug_vs_placebo_TRIPLE.png}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{@{}lllllll@{}}
            Podskupina               & Použitý model & MTTF {[}dnů{]} & $t_{\mbox{med}}$ & MRL {[}dnů{]} &  &  \\
            \multirow{2}{*}{Lék}     & logNormal2P   &                &                  &               &  &  \\
            & Kaplan-Meier  &                & 54               &               &  &  \\
            \multirow{2}{*}{Placebo} & Exp1P         &                &                  &               &  &  \\
            & Kaplan-Meier  &                & 29               &               &  & 
        \end{tabular}
